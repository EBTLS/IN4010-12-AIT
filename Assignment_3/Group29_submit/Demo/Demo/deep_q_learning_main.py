...
if __name__ == "__main__":
    ...
    q2 = QLearner(env, qn, discount, isReplayMem=True)
    q3 = QLearner(env, qn, discount, target_network=target_qn, isReplayMem=True)
    
    # act_loop(env, ql, NUM_EPISODES)
    act_loop(env, q2, NUM_EPISODES)
    act_loop(env, q3, NUM_EPISODES)
